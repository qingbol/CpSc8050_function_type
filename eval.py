...
class Model(object):
    ...
    def test(self):
        ...
        while self.datasets.test_tag:
            ...
            print "type of feed_dict[data_pl] befor run ", feed_dict.keys
            # print "type of feed_dict[data_pl] befor run ", type(feed_dict[data_pl])
            # print "len of feed_dict[data_pl] befor run ", len(feed_dict[data_pl])
            # print "data of feed_dict[data_pl] befor run ", feed_dict[data_pl]
